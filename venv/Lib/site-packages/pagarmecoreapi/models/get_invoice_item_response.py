...
import pagarmecoreapi.models.get_pricing_scheme_response
import pagarmecoreapi.models.get_price_bracket_response
...
class GetInvoiceItemResponse(object):
    ...
    def from_dictionary(cls,
        ...
        pricing_scheme = pagarmecoreapi.models.get_pricing_scheme_response.GetPricingSchemeResponse.from_dictionary(dictionary.get('pricing_scheme')) if dictionary.get('pricing_scheme') else None
        price_bracket = pagarmecoreapi.models.get_price_bracket_response.GetPriceBracketResponse.from_dictionary(dictionary.get('price_bracket')) if dictionary.get('price_bracket') else None
