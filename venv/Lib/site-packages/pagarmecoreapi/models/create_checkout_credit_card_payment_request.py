...
import pagarmecoreapi.models.create_checkout_card_installment_option_request
import pagarmecoreapi.models.create_payment_authentication_request
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('installments') != None:
            ...
            for structure in dictionary.get('installments'):
                installments.append(pagarmecoreapi.models.create_checkout_card_installment_option_request.CreateCheckoutCardInstallmentOptionRequest.from_dictionary(structure))
