...
import pagarmecoreapi.models.get_anticipation_response
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('data') != None:
            ...
            for structure in dictionary.get('data'):
                data.append(pagarmecoreapi.models.get_anticipation_response.GetAnticipationResponse.from_dictionary(structure))
