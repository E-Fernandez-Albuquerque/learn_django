...
import pagarmecoreapi.models.get_invoice_item_response
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('items') != None:
            ...
            for structure in dictionary.get('items'):
                items.append(pagarmecoreapi.models.get_invoice_item_response.GetInvoiceItemResponse.from_dictionary(structure))
        charge = pagarmecoreapi.models.get_charge_response.GetChargeResponse.from_dictionary(dictionary.get('charge')) if dictionary.get('charge') else None
        ...
        cycle = pagarmecoreapi.models.get_period_response.GetPeriodResponse.from_dictionary(dictionary.get('cycle')) if dictionary.get('cycle') else None
