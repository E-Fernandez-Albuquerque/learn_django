...
import pagarmecoreapi.models.get_phones_response
...
class GetCustomerResponse(object):
    ...
    def from_dictionary(cls,
        ...
        address = pagarmecoreapi.models.get_address_response.GetAddressResponse.from_dictionary(dictionary.get('address')) if dictionary.get('address') else None
        metadata = dictionary.get('metadata')
        phones = pagarmecoreapi.models.get_phones_response.GetPhonesResponse.from_dictionary(dictionary.get('phones')) if dictionary.get('phones') else None
