...
import pagarmecoreapi.models.create_three_d_secure_request
...
class CreatePaymentAuthenticationRequest(object):
    ...
    def from_dictionary(cls,
        ...
        threed_secure = pagarmecoreapi.models.create_three_d_secure_request.CreateThreeDSecureRequest.from_dictionary(dictionary.get('threed_secure')) if dictionary.get('threed_secure') else None
