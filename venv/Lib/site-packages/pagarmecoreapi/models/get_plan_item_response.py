...
import pagarmecoreapi.models.get_plan_response
...
class GetPlanItemResponse(object):
    ...
    def from_dictionary(cls,
        ...
        plan = pagarmecoreapi.models.get_plan_response.GetPlanResponse.from_dictionary(dictionary.get('plan')) if dictionary.get('plan') else None
