...
import pagarmecoreapi.models.get_access_token_response
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('data') != None:
            ...
            for structure in dictionary.get('data'):
                data.append(pagarmecoreapi.models.get_access_token_response.GetAccessTokenResponse.from_dictionary(structure))
