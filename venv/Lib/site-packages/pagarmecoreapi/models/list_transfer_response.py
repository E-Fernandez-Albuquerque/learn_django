...
import pagarmecoreapi.models.get_transfer_response
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('data') != None:
            ...
            for structure in dictionary.get('data'):
                data.append(pagarmecoreapi.models.get_transfer_response.GetTransferResponse.from_dictionary(structure))
